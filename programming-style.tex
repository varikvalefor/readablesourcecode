...
For all functions $f$, the line-based length of $f$'s definition is less than or equal to fifteen (15).  Lines of documentation and the lengths of the declarations of the sub-functions and sub-variables which are properly ``separated'' from the ``real'' function are not counted.
\subsection{Explaining the Choice}
\subsubsection{Definitions}
