...
Functions which are excessively lengthy should be split into multiple global functions iff other functions likely benefit from the creation of such global functions.
...
For all excessively lengthy functions $f$, $f$ should be broken into multiple functions which are usable only within the scope of $f$ iff the resulting sub-functions are likely of use only within the scope of $f$.
\section{Examples}
